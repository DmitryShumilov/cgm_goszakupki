...
# Используем директорию в профиле пользователя
HOME_DIR = os.path.expanduser("~")
PG_DATA_DIR = os.path.join(HOME_DIR, "postgresql_data")
...
# Инициализация кластера (без явной локали для совместимости)
