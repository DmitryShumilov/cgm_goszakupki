...
**Версия проекта:** 1.5.1 (Comparison Dashboard - Auto Launch) 🆕
...
**Примечание:** Дашборд сравнения периодов реализован в v1.5.0 ✅
...
**Документация актуальна для версии проекта 1.5.1 (Comparison Dashboard - Auto Launch)** 🆕
