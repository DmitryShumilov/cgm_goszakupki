...
API использует ограничение запросов для защиты от перегрузки:

| Endpoint | Лимит |
|----------|-------|
| `GET /api/health`, `GET /` | 30 запросов/минуту |
| `POST /api/kpi`, `POST /api/charts/*` | 60 запросов/минуту |
| `GET /api/filters/*` | Без ограничений |

**Превышение лимита:** Ответ `429 Too Many Requests`
